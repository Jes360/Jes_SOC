...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **T1110.001** | Brute Force: Password Guessing | Credential Access | `detections/sigma/windows_failed_logon.yml`<br>`correlations/corr_det01_bruteforce_threshold.yml` | `TC-AUTH-001`<br>`TC-POS-001`<br>`TC-POS-002`<br>`TC-NEG-001`<br>`TC-NEG-002`<br>`TC-NEG-003` | 🟢 VALIDATED — Audit PASS (Tag `v0.3.0`, Commit `4bdf920`, CI Run `34933601381`) |
| **T1078.003** | Valid Accounts: Local Accounts | Initial Access / Persistence | `detections/sigma/windows_successful_logon.yml` | `TC-AUTH-002`<br>`TC-POS-002`<br>`TC-NEG-001`..`006` | 🟡 IMPLEMENTED — DET-02-PRIM Canonical Rule, Translations & 8-Case Boundary Engine Verified |
...
* **Current Status:** 0 Passed / 12 Initialized (Target: 12/12 Passed for V1.0.0 Tag)
