...
| **T1059.001** | Command & Scripting Interpreter: PowerShell | Execution | `detections/sigma/windows_suspicious_powershell.yml`<br>`telemetry/generators/gen-powershell-events.ps1` | `TC-AUTH-004`<br>`TC-POS-004`..`005`<br>`TC-NEG-013`..`016` | 🟡 IMPLEMENTED — DET-03 Canonical Rule, Translations & 7-Case Boundary Engine Verified |
